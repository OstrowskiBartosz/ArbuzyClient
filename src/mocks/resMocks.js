...
export const searchResultsWithB20Elements = {
  products: [
    {
      productID: 1,
      quantity: 5,
    ...
    },
    {
      ...
      Category: { categoryID: 1, categoryName: 'Dyski HDD' },
      Manufacturer: { manufacturerID: 1, manufacturerName: 'Western Digital' },
      Prices: [{ netPrice: 300.48, grossPrice: 369.59 }],
      va: [
        { attributeID: 88 },
        { attributeID: 89 },
        { attributeID: 90 },
      ...
      Attributes: [
        { property: 'Format dysku', value: '2.5"' },
        { property: 'Pojemność dysku [GB]', value: '1000' },
        { property: 'image', value: '/images/products/14/883195_1_i1064.jpeg' }
      ]
    },
    {
      productID: 15,
    ...
    },
    {
      productID: 16,
      quantity: 10,
      productName: 'Digital Blue 1 TB 3.5" SATA III (WD10EZRZ)',
      Category: { categoryID: 1, categoryName: 'Dyski HDD' },
      Manufacturer: { manufacturerID: 1, manufacturerName: 'Western Digital' },
      Prices: [{ netPrice: 144.04, grossPrice: 177.17 }],
      va: [
        { attributeID: 107 },
        { attributeID: 108 },
        { attributeID: 109 },
      ...
      Attributes: [
        { property: 'Format dysku', value: '3.5"' },
        { property: 'Pojemność dysku [GB]', value: '1000' },
        { property: 'image', value: '/images/products/16/764807_0_i1064.jpeg' }
      ]
    },
    {
      productID: 17,
      quantity: 10,
      productName: 'Burst 240GB SATA3 (PBU240GS25SSDR)',
      Category: { categoryID: 2, categoryName: 'Dyski SSD' },
      Manufacturer: { manufacturerID: 24, manufacturerName: 'Patriot' },
      Prices: [{ netPrice: 97.15, grossPrice: 119.5 }],
      va: [
        { attributeID: 117 },
        { attributeID: 118 },
        { attributeID: 120 },
      ...
      Attributes: [
        { property: 'Pojemność dysku [GB]', value: '240' },
        { property: 'Format dysku', value: '2.5"' },
        { property: 'image', value: '/images/products/17/978122_0_i1064.jpg' }
      ]
    },
    {
      productID: 18,
      ...
      Category: { categoryID: 2, categoryName: 'Dyski SSD' },
      Manufacturer: { manufacturerID: 5, manufacturerName: 'Transcend' },
      Prices: [{ netPrice: 89.33, grossPrice: 109.88 }],
      va: [
        { attributeID: 124 },
        { attributeID: 125 },
        { attributeID: 126 },
      ...
      Attributes: [
        { property: 'Format dysku', value: 'M.2' },
        { property: 'Pojemność dysku [GB]', value: '120' },
        { property: 'image', value: '/images/products/18/1137287_0_i1064.jpg' }
      ]
    },
    {
      productID: 19,
      ...
      productName: '545 Series 512GB SATA3 (SSDSC2KW512G8X1)',
      Category: { categoryID: 2, categoryName: 'Dyski SSD' },
      Manufacturer: { manufacturerID: 4, manufacturerName: 'Intel' },
      Prices: [{ netPrice: 451.15, grossPrice: 554.91 }],
      va: [
        { attributeID: 132 },
        { attributeID: 133 },
        { attributeID: 134 },
      ...
      Attributes: [
        { property: 'Format dysku', value: '2.5"' },
        { property: 'Pojemność dysku [GB]', value: '512' },
        { property: 'image', value: '/images/products/19/1497912_0_i1064.jpg' }
      ]
    },
    {
      productID: 20,
...
export const searchResultsWithBar = {
  products: [
    {
      productID: 1,
      quantity: 5,
